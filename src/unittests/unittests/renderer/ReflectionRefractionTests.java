...
class ReflectionRefractionTests {
	private Scene scene = new Scene("Test scene");
	   ...
	   @Test
	   public void fullPictureTest()
	   {
		   //set place and size of camera
		   ...
		   //set the whole scene
	        ...
	        scene.geometries.add( //
	                new Triangle(new Point(450, -350, 0),
	                        ...
	                        .setMaterial(new Material().setkR(1d).setkS(0.1).setShininess(10)),//
